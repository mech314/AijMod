...
CanMessageSetupStruct ccm08 CANDATA = {.id = 0x620,	.ext = 0,	.dlc = 8,	.bus = 0,	.mailBox = 27,	.mcs = mcsTrans, 	.nmc = 0, .rate =  10, .callback = 0};
CanMessageSetupStruct ccm09 CANDATA = {.id = 0x621,	.ext = 0,	.dlc = 8,	.bus = 0,	.mailBox = 28,	.mcs = mcsTrans, 	.nmc = 0, .rate =  10, .callback = (unsigned long)&counterCallBack};
CanMessageSetupStruct ccm10 CANDATA = {.id = 0x622,	.ext = 0,	.dlc = 8,	.bus = 0,	.mailBox = 29,	.mcs = mcsTrans, 	.nmc = 0, .rate =  10, .callback = 0};
