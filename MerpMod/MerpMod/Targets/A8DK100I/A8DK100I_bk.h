#define MOD_IDENTIFIER STRI(A8DK100I.MeRpMoD.Switch.Testing.v01.40.d13.10.23.21.19)
...
#define ECU_CALIBRATION_ID A8DK100I
#define ECU_IDENTIFIER 4342594006
#define AUTO_TRANS 0
#define SD_DMAP		0
#define ECU_IDENTIFIER_CHARS (10)
#define ECU_CALIBRATION_CHARS (8)
#define MOD_CALIBRATION_ID	B8DK100I
#define MOD_ECU_IDENTIFIER 0342594006
