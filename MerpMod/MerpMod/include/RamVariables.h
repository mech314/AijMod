...
typedef struct
{
	...
	//AT emu
	// Message 420
	unsigned char m420_b0;
	unsigned char m420_b1;
	unsigned char m420_b2;
	unsigned char m420_b3;
	unsigned char m420_b5;
	unsigned char m420_b6;
	unsigned char m420_b7;
	// Message 421
	unsigned char m421_b0;
	unsigned char m421_b3; //counter
	// Message 422
	unsigned char m422_b2;
	unsigned char m422_b7;
		
	unsigned short ccmSendTimers[ccmCount];
	unsigned short sdTimer;
	
	//unsigned char customValue;
